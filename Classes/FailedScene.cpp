...
void 
Failed::draw(Renderer *renderer, const Mat4 &transform, uint32_t flags){
	//Director::getInstance()->setProjection(Director::Projection::_2D);
}

void Failed::update(float delta){
	//Director::getInstance()->setProjection(Director::Projection::_2D);
...
bool Failed::onTouchBegan(cocos2d::Touch* , cocos2d::Event*){
	Director::getInstance()->replaceScene(TransitionFade::create(1.0f,Title::createScene()));
	return true;
}
	
void Failed::onTouchMoved(cocos2d::Touch* t,cocos2d::Event*){
...
void Failed::menuCloseCallback(Ref* pSender)
{

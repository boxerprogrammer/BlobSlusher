...
Scene* Title::createScene()
{
	...
	//auto hello = GamePlaying::create();
	//scene->addChild(hello,0);
...
void 
Title::draw(Renderer *renderer, const Mat4 &transform, uint32_t flags){
	//Director::getInstance()->setProjection(Director::Projection::_2D);
}
...
bool Title::onTouchBegan(cocos2d::Touch* , cocos2d::Event*){
	Director::getInstance()->replaceScene(TransitionFade::create(1.0f,GamePlaying::createScene()));
	return true;
}
	
void Title::onTouchMoved(cocos2d::Touch* t,cocos2d::Event*){
